    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          .setAuthor(`| Now playing`, client.botconfig.IconURL,"https://discord.gg/HAQAqYgPFG")
      ...
      .on("queueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("| The queue has ended", this.botconfig.IconURL,"https://discord.gg/HAQAqYgPFG")
          .setColor(this.botconfig.EmbedColor)
          .setTimestamp();
