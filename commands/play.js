  ...
  run: async (client, message, args, { GuildDB }) => {
    if (!message.member.voice.channel)
      return client.sendTime(
        message.channel,
        "❌ | **[You must be in a voice channel to play something!](https://discord.gg/mmqHpEmXjU)**"
      );
    if (
      ...
      return client.sendTime(
        message.channel,
        `:x: | **[You must be in the same voice channel as me to use this command!](https://discord.gg/mmqHpEmXjU)**`
      );
    ...
    if (!player)
      return client.sendTime(
        message.channel,
        "❌ | **[Nothing is playing right now...](https://discord.gg/mmqHpEmXjU)**"
      );
      ...
      if (SearchString.match(client.Lavasfy.spotifyPattern)) {
        ...
        if (Searched.loadType === "PLAYLIST_LOADED") {
          ...
          if (player.queue.totalSize > 1)
            SongAddedEmbed.addField(
              "| [Position in queue](https://discord.gg/mmqHpEmXjU)",
              `${player.queue.size - 0}`,
              true
            );
          Searching.edit(SongAddedEmbed);
        ...
        if (Searched.loadType === "NO_MATCHES")
          ...
          Searching.edit(SongAddedEmbed).then(msg => {
      ...
      if (search.match(client.Lavasfy.spotifyPattern)) {
        ...
        try {
          ...
          if (res.loadType === "LOAD_FAILED") {
            ...
            return client.sendError(
              interaction,
              `[:x: | **There was an error while searching**](https://discord.gg/mmqHpEmXjU)`
            );
          }
        } catch (err) {
          return client.sendError(
        ...
        switch (res.loadType) {
          ...
          case "SEARCH_RESULT":
            ...
            if (!player.playing && !player.paused && !player.queue.length) {
              ...
              interaction.send(SongAddedEmbed).then(msg => {
    setTimeout(() => msg.delete(), 3000)
  });
            }
        }
